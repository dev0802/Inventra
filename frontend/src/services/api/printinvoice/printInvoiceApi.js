...
export const getCustomerByPhone = async (phone1Country, phone1) => {
  const response = await fetch(
    `${process.env.REACT_APP_API_GET_CUSTOMER_BY_PHONE}?phone1Country=${encodeURIComponent(phone1Country)}&phone1=${encodeURIComponent(phone1)}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const updateCustomerDetail = async (customerData) => {
  const response = await fetch(
    `${process.env.REACT_APP_API_UPDATE_CUSTOMER_DETAIL}`,
    {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
...
export const getProductByItemCode = async (itemCode) => {
  const response = await fetch(
    `${process.env.REACT_APP_API_GET_PRODUCT_BY_ITEM_CODE}?itemCode=${encodeURIComponent(itemCode)}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const saveItemDetail = async (rows) => {
  const response = await fetch(
    `${process.env.REACT_APP_API_SAVE_ITEM_DETAIL}`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export const getInvoiceById = async (invoice_id) => {
  const response = await fetch(
    `${process.env.REACT_APP_API_GET_INVOICE_BY_ID}/${invoice_id}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const getInvoicesByFY = async (financial_year) => {
  const response = await fetch(
    `${process.env.REACT_APP_API_GET_INVOICES_BY_FY}/${financial_year}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const getInvoiceByNumberAndFY = async (
  invoice_number,
  financial_year,
) => {
  const response = await fetch(
    `${process.env.REACT_APP_API_GET_INVOICE_BY_NUMBER_AND_FY}?invoice_number=${encodeURIComponent(invoice_number)}&financial_year=${encodeURIComponent(financial_year)}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const updateInvoice = async (
  invoice_number,
  { customer, items, invoice_date },
) => {
  const response = await fetch(
    `${process.env.REACT_APP_API_UPDATE_INVOICE}/${invoice_number}`,
    {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
