        ...
        <div className="w-full flex justify-center">
          <nav className="flex flex-row justify-center gap-1 sm:gap-5 bg-transparent">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? 'flex items-center text-center text-gray-600 text-lg border-b-[3px] border-gray-600 font-semibold px-1 md:px-4 py-1.5 md:py-2 whitespace-nowrap self-stretch'
      : 'flex items-center text-center text-white text-lg border-b-[3px] border-transparent hover:border-gray-600 hover:text-gray-600 font-semibold px-1 md:px-4 py-1.5 md:py-2 whitespace-nowrap self-stretch'
